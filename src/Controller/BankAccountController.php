...
class BankAccountController extends AbstractController
{
    ...
    #[Route('/banKAccount', name: 'app_BanKAccount', methods: ['GET'])]
    ...
    #[Route('/banKAccountById/{id}', name: 'BanKAccount_show')]
...
#[Route('/banKAccountNew', name: 'create_banKAccount', methods: ['POST'])]
