 ...
 */
final class Version20231219150233 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD CONSTRAINT FK_723705D198F3E05A FOREIGN KEY (fk_trt_id_id) REFERENCES transaction (id)');
